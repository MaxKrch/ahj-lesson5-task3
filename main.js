...
;// CONCATENATED MODULE: ./src/js/RenderWidget.js
...
class RenderWidget {
  ...
  showDate(date, ceil) {
    ...
    ceilDiv.textContent = moment_default()(date).locale("ru").format("DD MMMM YYYY");
    if (ceil === "there") {
      const there = moment_default()(this.dates.there.textContent, "DD MMMM YYYY", "ru");
      const back = moment_default()(this.dates.back.textContent, "DD MMMM YYYY", "ru");
...
class Calendar {
  ...
  createArrayDates() {
    const startOfMonth = moment_default()().startOf("month");
    const startOfWeek = moment_default()(startOfMonth).startOf("week").add(1, "days");
  ...
  renderStartingCalendar() {
    const month = moment_default()().locale("ru").format("MMM YYYY");
  ...
  renderCalendarDaysOfWeek() {
    ...
    const monday = moment_default()().startOf("week");
    for (let i = 1; i <= 7; i += 1) {
  ...
  renderCalendarTd(date, index) {
    ...
    cell.textContent = moment_default()(date).locale("ru").format("DD");
    if (moment_default()(date).locale("ru").format("dd") === "сб" || moment_default()(date).locale("ru").format("dd") === "вс") {
      cell.classList.add("calendar-dayOff");
    }
    if (moment_default()().isSame(date, "day")) {
      cell.classList.add("calendar-body-today");
    }
    if (!moment_default()().isSame(date, "month")) {
      cell.classList.add("calendar-body-date-othermonth");
    }
    if (moment_default()().isSameOrAfter(date, "day")) {
      cell.classList.add("calendar-body-date-passive");
    }
    if (this.calendar.dataset.direction === "there") {
      if (this.selectedDate.there && moment_default()(date).isSame(this.selectedDate.there, "day")) {
        cell.classList.add("calendar-body-date-selected");
      }
    }
    if (this.calendar.dataset.direction === "back") {
      if (this.selectedDate.back && moment_default()(date).isSame(this.selectedDate.back, "day")) {
        cell.classList.add("calendar-body-date-selected");
      }
      if (this.selectedDate.there && moment_default()(this.selectedDate.there).isAfter(date)) {
        cell.classList.add("calendar-body-date-passive");
      }
    }
    return cell;
  ...
  dateSelection(cell) {
    ...
    if (direction === "there" && moment_default()(this.selectedDate.there).isAfter(this.selectedDate.back)) {
      this.selectedDate.back = null;
  ...
  flipCalendar(flip) {
    ...
    const month = moment_default()(oldMonth, "MMM YYYY", "ru");
    const newMonth = month.add(flip, "months");
    const startOfMonth = moment_default()(newMonth).startOf("month").locale("en");
    const startOfWeek = moment_default()(startOfMonth).startOf("week").add(1, "days");
    this.updateArrayDates(startOfWeek);
    ...
    if (flip < 0 && moment_default()().isSame(newMonth, "months")) {
